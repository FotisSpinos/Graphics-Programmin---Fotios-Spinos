...
void Shader::init(const std::string& vertFile, const std::string& fragFile, const std::string& geomShader)
{
	...
	shaders[2] = CreateShader(LoadShader(geomShader), GL_GEOMETRY_SHADER);	//create geometry shader
